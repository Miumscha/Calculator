...
chars = ['a','s','d','g','e','h','v','b','z','u','q','y','x','m','n','o','p','1','2','3','4',
         '5','6','7','8','9','0','A','B','U','I','O','L','J','M','N','B','V','F']

font = pygame.font.Font(None, FONT_SIZE)
font_2 = pygame.font.Font(None, FONT_SIZE - FONT_SIZE // 6)
font_3 = pygame.font.Font(None, FONT_SIZE - FONT_SIZE // 3)
...
class Symbol:
    ...
    def draw_2(self):
        self.value = choice(green_chars_2)
        self.y = self.y + self.speed if self.y < HEIGHT else -FONT_SIZE * randrange(1, 10)
        screen.blit(self.value, (self.x, self.y))

    def draw_3(self):
        self.value = choice(green_chars_3)
        self.y = self.y + self.speed if self.y < HEIGHT else -FONT_SIZE * randrange(1, 10)
        screen.blit(self.value, (self.x, self.y))
...
while run:
    ...
    [symbol_2.draw() for symbol_2 in symbols_2]
    [symbol_3.draw() for symbol_3 in symbols_3]
